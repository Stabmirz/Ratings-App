...
class Review extends Component {
  ...
  handleValidation = (event) => {
    ...
    switch (name) {
      case "title":
        errors.title = value.length !== " " ? "Please enter a title!" : "";
        errors.title = value.length < 1 ? "Please enter a title!" : "";
        break;
      case "review":
        errors.review = value.length !== " " ? "Please enter a review" : "";
  ...
  handleSubmit = (event) => {
    ...
    errors.recommendation =
      recommendation.length === 0 ? "Please select a recommendation" : "";
